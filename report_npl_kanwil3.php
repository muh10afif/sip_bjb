...
$conn = sqlsrv_connect( $serverName, $connectionInfo);
    ...
    $sql_del = "DROP TABLE report_npl_kanwil_3";
    ...
    while( $row = sqlsrv_fetch_array( $hasil_seg, SQLSRV_FETCH_ASSOC) ) {
        ...
        if ($i == 1) {
            ...
            $sql_c = "CREATE TABLE report_npl_kanwil_3 (id INT IDENTITY PRIMARY KEY, nama VARCHAR(255) , cabang_induk VARCHAR(200), reg_employee VARCHAR(100) , urutan INT , total INT, $segmen INT,  add_time datetime DEFAULT GETDATE() )";

            $hasil_c = sqlsrv_query( $conn, $sql_c);
            
        } else {

            $sql_c = "ALTER TABLE report_npl_kanwil_3 ADD $segmen INT";
    ...
    $sql0 = "SELECT DISTINCT kanwil FROM m_debitur WHERE kanwil = 'Kanwil 3' ORDER BY kanwil ASC";
    ...
    while( $row = sqlsrv_fetch_array( $hasil0, SQLSRV_FETCH_ASSOC) ) {
        ...
        while( $row_seg = sqlsrv_fetch_array( $hasil_seg, SQLSRV_FETCH_ASSOC) ) {
            ...
            $sql13 = "SELECT * FROM report_npl_kanwil_3 WHERE nama = '$kanwil'";

            $hasil13 = sqlsrv_query( $conn, $sql13);

            if (sqlsrv_has_rows( $hasil13 ) === true) {

                $sql_input = "UPDATE report_npl_kanwil_3 SET nama = '$kanwil', urutan = 1, $segmen3 = $total_kelolaan_kanwil, total = $total WHERE nama = '$kanwil'";
            
                $hasil_in = sqlsrv_query( $conn, $sql_input);
                
            } else {

                $sql_input = "INSERT INTO report_npl_kanwil_3 (nama, urutan, $segmen3, total) values('$kanwil', 1, $total_kelolaan_kanwil, $total)";
            ...
            while( $rowc = sqlsrv_fetch_array( $hasil0c, SQLSRV_FETCH_ASSOC) ) {
                ...
                while( $row_segc = sqlsrv_fetch_array( $hasil_segc, SQLSRV_FETCH_ASSOC) ) {
                    ...
                    $sql13c = "SELECT * FROM report_npl_kanwil_3 WHERE nama = '$cabang_induk'";

                    $hasil13c = sqlsrv_query( $conn, $sql13c);

                    if (sqlsrv_has_rows( $hasil13c ) === true) {

                        $sql_inputc = "UPDATE report_npl_kanwil_3 SET nama = '$cabang_induk', cabang_induk='$cabang_induk', urutan = 2, $segmen3c = $total_kelolaan_cabang, total = $total_cabang WHERE nama = '$cabang_induk'";
                    
                        $hasil_inc = sqlsrv_query( $conn, $sql_inputc);
                        
                    } else {

                        $sql_inputc = "INSERT INTO report_npl_kanwil_3 (nama, cabang_induk, urutan, $segmen3c, total) values('$cabang_induk', '$cabang_induk', 2, $total_kelolaan_cabang, $total_cabang)";
                    ...
                    while( $rowca = sqlsrv_fetch_array( $hasil0ca, SQLSRV_FETCH_ASSOC) ) {
                        ...
                        while( $row_segca = sqlsrv_fetch_array( $hasil_segca, SQLSRV_FETCH_ASSOC) ) {
                            ...
                            $sql13ca = "SELECT * FROM report_npl_kanwil_3 WHERE nama = '$ao'";

                            $hasil13ca = sqlsrv_query( $conn, $sql13ca);

                            if (sqlsrv_has_rows( $hasil13ca ) === true) {

                                $sql_inputca = "UPDATE report_npl_kanwil_3 SET nama = '$ao',  cabang_induk='$cabang_induk', reg_employee = '$reg_employee', urutan = 3, $segmen3ca = $total_kelolaan_ao, total = $total_ao WHERE nama = '$ao'";
                                ...
                                $sql_inputca = "INSERT INTO report_npl_kanwil_3 (nama, cabang_induk, reg_employee, urutan, $segmen3ca, total) values('$ao', '$cabang_induk',  '$reg_employee', 3, $total_kelolaan_ao, $total_ao)";
                            ...
                            while( $rowcak = sqlsrv_fetch_array( $hasil0cak, SQLSRV_FETCH_ASSOC) ) {
                                ...
                                while( $row_segcak = sqlsrv_fetch_array( $hasil_segcak, SQLSRV_FETCH_ASSOC) ) {
                                    ...
                                    $sql13cak = "SELECT * FROM report_npl_kanwil_3 WHERE nama = '$kolektibilitas' AND cabang_induk = '$cabang_induk' AND reg_employee = '$reg_employee'";

                                    $hasil13cak = sqlsrv_query( $conn, $sql13cak);

                                    if (sqlsrv_has_rows( $hasil13cak ) === true) {

                                        $sql_inputcak = "UPDATE report_npl_kanwil_3 SET nama = '$kolektibilitas', urutan = 4, $segmen3cak = $total_kelolaan_kolek, cabang_induk = '$cabang_induk', reg_employee = '$reg_employee', total = $total_kolek WHERE nama = '$kolektibilitas' AND cabang_induk = '$cabang_induk' AND reg_employee = '$reg_employee'";
                                        ...
                                        $sql_inputcak = "INSERT INTO report_npl_kanwil_3 (nama, urutan,$segmen3cak, cabang_induk, reg_employee, total) values('$kolektibilitas', 4, $total_kelolaan_kolek, '$cabang_induk', '$reg_employee', $total_kolek)";
