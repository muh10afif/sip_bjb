    ...
    <body class="skin-default">
        ...
        <div class="wrapper">                
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                               <form method="post" action="<?php echo base_url("export/formWO"); ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                   ...
                   <?php
                    if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
                        ...
                        echo "<form method='post' action='".base_url("export/simpanWO")."'>";
                        ...
                        // $sheet adalah variabel yang dikirim dari controller
                            ...
                            <?php
                                ...
                                $tgl_wo         = $row['M'];
                                $plafond        = $row['N'];
                                $tunggakan_pokok= $row['O'];
                                $bunga_lapor    = $row['P'];
                                $bunga_ekstra   = $row['Q'];
                                $denda          = $row['R'];
                                // Cek jika semua data tidak diisi
                                if(empty($nama) && empty($cif) && empty($alamat) && empty($telpon) && empty($kanwil) && empty($cabang) && empty($kantor)&& empty($segmen) && empty($loan)&& empty($deal) && empty($start)&& empty($mat) && empty($tgl_wo)&& empty($plafond) && empty($tunggakan_pokok)&& empty($bunga_lapor) && empty($bunga_ekstra)&& empty($denda))
                                ...
                                if($numrow > 1){
                                    ...
                                    if(empty($nama) && empty($cif) && empty($alamat) && empty($telpon) && empty($kanwil) && empty($cabang) && empty($kantor)&& empty($segmen) && empty($loan)&& empty($deal) && empty($start)&& empty($mat) && empty($tgl_wo)&& empty($plafond) && empty($tunggakan_pokok)&& empty($bunga_lapor) && empty($bunga_ekstra)&& empty($denda)){
                                        ...
                                        echo "<td>".$tgl_wo."</td>";
                                        echo "<td>".$plafond."</td>";
                                        echo "<td>".$tunggakan_pokok."</td>";
                                        echo "<td>".$bunga_lapor."</td>";
                                        echo "<td>".$bunga_ekstra."</td>";
                                        echo "<td>".$denda."</td>";
                                        echo "</tr>";
                                        echo "</tbody>";
                                    }
                                ...
                                echo "</table>";
                                 ...
                                 // Jika semua data sudah diisi
                                    ...
                                    echo "<a href='".base_url("export/formWO")."'><button class='btn btn-success'>Cancel</button></a>";
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2019 Solusi Karya Digital.</strong> All rights reserved.
            </footer>
