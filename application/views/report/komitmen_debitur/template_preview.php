...
<?php if ((!isset($_POST['pdf'])) || (!isset($_POST['excel']))): ?>
	<form method="POST" target="_self" id="tab" action="<?= base_url('report/monitoring') ?>">
		<input type="hidden" name="debitur" value="<?= $p_debitur ?>">
	    ...
	    <input type="hidden" name="komitmen" value="<?= $p_komitmen ?>">
	    <input type="hidden" name="monitoring" value="<?= $p_monitoring ?>">
	    <input type="hidden" name="kanwil" value="<?= $p_kanwil ?>">
	    <input type="hidden" name="cabang" value="<?= $p_cabang ?>">
	    <input type="hidden" name="bulan" value="<?= $p_bulan ?>">
