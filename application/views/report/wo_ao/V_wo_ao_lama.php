							...
							<tr>
								...
								<?php endif ?>
									...
									<tr>
										...
										<?php if (empty($p_kol)): ?>
											<?php $result_kol = $this->db->query("SELECT * FROM m_kolektibilitas WHERE id != 3 AND id != 4 AND id != 5")->result_array(); ?>
										<?php else: ?>
										...
										<tr>
											...
											$total = 0;  ?>
											<td style="display: none;"><?= $a ?></td>
											<td style="font-size: 13px; padding-left: 90px;"> <?= $c = $kol['kolektibilitas'] ?> </td>
