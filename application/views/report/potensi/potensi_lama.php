...
<div class="row">
    <div class="col-md-3">
        <a href="<?= base_url('report/potensi/npl') ?>"><button class="btn <?= ($jenis == 'npl') ? 'btn-primary' : 'btn-default' ?> btn-block"><?= ($jenis == 'npl') ? "<i class='fa fa-circle'></i>".nbs(2)  : "<i class='fa fa-circle-o'></i>".nbs(2) ?>Status Debitur NPL</button></a>
    </div>
    <div class="col-md-3">
        <a href="<?= base_url('report/potensi/wo') ?>"><button class="btn <?= ($jenis == 'wo') ? 'btn-primary' : 'btn-default' ?> btn-block"><?= ($jenis == 'wo') ? "<i class='fa fa-circle'></i>".nbs(2) : "<i class='fa fa-circle-o'></i>".nbs(2) ?>Status Debitur WO</button></a>
    </div>
</div><br>
<div class="row">
        <div class="col-md-12">
        ...
        <div class="box box-primary box-solid">
            ...
            <form method="POST" target="_self" id="tab" action="<?= base_url('report/potensi') ?>">
            ...
            <div class="box-footer">
                <div class="col-md-12" align="center">
                    ...
                    <a href="<?= base_url("report/potensi/$jenis") ?>"><button class="btn btn-success" type="button" style="margin-top: 5px"><i class="fa fa-bars"></i><?= nbs(2) ?>Tampilkan Semua</button></a><?= nbs(3) ?>
...
<div class="row">
  <div class="col-md-6">
    <div class="box box-primary box-solid">
      <div class="box-header with-border">
        <h1 class="box-title">Potensi Recoveries Jenis Debitur <?= strtoupper($jenis) ?></h1>
      </div>
      <div class="box-body">
        ...
        <table class="table table-hover table-striped table-bordered " data-scroll-x="true" id="potensi" width="100%">
          ...
          <?php endif ?>
            ...
            <tr>
              ...
              <?php 
                  $this->db->select('SUM(a.nominal) as total_kelolaan');
                  ...
                  if (!empty($p_bulan) || !empty($p_segmen) || !empty($p_kanwil) || !empty($p_cabang) || !empty($p_ao) || !empty($p_debitur) ) {
                    
                      if (!empty($p_bulan)) {
                          $this->db->where("a.tgl_komitmen LIKE '%$p_bulan%' ");
                      }
                      if (!empty($p_segmen)) {
                ...
                <td align="right"><?= ($result->total_kelolaan == null) ? 0 : number_format($result->total_kelolaan,'0','.','.'); ?> </td>
